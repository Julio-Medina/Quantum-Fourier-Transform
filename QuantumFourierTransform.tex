...
En Qiskit la implementación de la compuerta $C\, ROT$ usada en los desarrollos previos, se conococe como rotación de fase controlada. Está compuerta está definida en \textbf{OpenQASM}, \cite{openQASM} de la siguiente manera:
\begin{equation}
CP(\theta)=
\begin{bmatrix}
1&0&0&0\\
